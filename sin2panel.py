...
class Sin2Panel (wx.Panel):
    ...
    def _createGui(self):
        ...
        freqLabel1 = wx.StaticText(self, label=u"Частота 1 (ГГц)")
        self.freqText1 = wx.TextCtrl(self)
        self.freqText1.SetMinSize((150, -1))

        ampLabel1 = wx.StaticText(self, label=u"Амплитуда 1 (В)")
        self.ampText1 = wx.TextCtrl(self)
        self.ampText1.SetMinSize((150, -1))

        # Параметры второй гармоники
        freqLabel2 = wx.StaticText(self, label=u"Частота 2 (ГГц)")
        self.freqText2 = wx.TextCtrl(self)
        self.freqText2.SetMinSize((150, -1))

        ampLabel2 = wx.StaticText(self, label=u"Амплитуда 2 (В)")
        self.ampText2 = wx.TextCtrl(self)
        self.ampText2.SetMinSize((150, -1))

        mainSizer.Add(freqLabel1,
                      1,
                      flag=wx.ALIGN_LEFT | wx.ALIGN_CENTER_VERTICAL | wx.ALL,
                      border=2
                      )

        mainSizer.Add(self.freqText1,
                      1,
                      flag=wx.ALIGN_RIGHT | wx.ALIGN_CENTER_VERTICAL | wx.ALL,
                      border=2
                      )

        mainSizer.Add(ampLabel1,
                      1,
                      flag=wx.ALIGN_LEFT | wx.ALIGN_CENTER_VERTICAL | wx.ALL,
                      border=2
                      )

        mainSizer.Add(self.ampText1,
                      1,
                      flag=wx.ALIGN_RIGHT | wx.ALIGN_CENTER_VERTICAL | wx.ALL,
                      border=2
                      )

        mainSizer.Add(freqLabel2,
                      1,
                      flag=wx.ALIGN_LEFT | wx.ALIGN_CENTER_VERTICAL | wx.ALL,
                      border=2
                      )

        mainSizer.Add(self.freqText2,
                      1,
                      flag=wx.ALIGN_RIGHT | wx.ALIGN_CENTER_VERTICAL | wx.ALL,
                      border=2
                      )

        mainSizer.Add(ampLabel2,
                      1,
                      flag=wx.ALIGN_LEFT | wx.ALIGN_CENTER_VERTICAL | wx.ALL,
                      border=2
                      )

        mainSizer.Add(self.ampText2,
                      1,
                      flag=wx.ALIGN_RIGHT | wx.ALIGN_CENTER_VERTICAL | wx.ALL,
                      border=2
                      )
